...
// Axios instance for Azure DevOps
...
// 1. Endpoint to fetch all work items with pagination and search filter
...
// 2. Endpoint to fetch a specific work item by its ID
...
// 3. Endpoint to fetch data from the "self" link of a work item
